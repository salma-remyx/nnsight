...
- [depth-averaged-truth-signals](depth-averaged-truth-signals.md) - Fit a linear truth probe at every layer from one activation cache and average the scores to detect hallucinations.
