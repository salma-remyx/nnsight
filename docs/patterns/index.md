...
- [vision-causal-scan](vision-causal-scan.md) - Sweep a clean-into-corrupt patch over (layer, image-region) pairs in a VLM's vision tower to find which vision tokens drove the answer.
