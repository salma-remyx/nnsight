...
- [trajectory-correction](trajectory-correction.md) - Score an iterated latent for drift each step and pull it back with a step-decayed, norm-capped intervention.
